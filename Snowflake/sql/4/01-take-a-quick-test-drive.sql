...
--         interface.
--         - Log into the Web UI and investigate its various functions.
--         - Create and modify a virtual warehouse using the Snowflake
--         infrastructure.
--         - Use standard SQL statements to modify an existing database.
--         - Examine Snowflake’s data organization structure, storage, compute,
--         and metadata in the Cloud services.

-- 1.1.0   Create Objects in the Web UI
--         In this task you will create objects that will be used for labs
...
--         For now, you are just creating objects that will be required in later
--         exercises.
...
--         These icons are used to activate different areas of the Web UI.
--         Identify each and attempt to learn their function. They are fairly
--         user-friendly in what they do.
...
-- 1.2.2   Click in the tab labeled New Worksheet and rename your worksheet Test
--         Drive.
...
--         of this workbook. Once you set these defaults, any worksheet you open
--         will automatically set your context to these values.
...
-- 1.3.9   Using the syntax in the commands above as a guide, write a query that
...
--         What are the lowest and highest prices returned? 104949.50 and 901.00
