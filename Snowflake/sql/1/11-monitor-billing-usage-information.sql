...
-- 11.2.7  Locate and click on your BADGER_WH and evaluate your usage over
--         time.
...
--         BADGER_WH Virtual Warehouse, ordered by time:

SELECT *
FROM TABLE(information_schema.warehouse_metering_history
(date_range_start=>date_trunc(month, current_date),
date_range_end=>dateadd(month,1,date_trunc(month, current_date)),'BADGER_WH'))
ORDER BY start_time;
