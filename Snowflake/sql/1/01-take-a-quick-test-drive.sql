...
-- 1.2.3   Name the database BADGER_DB.
...
-- 1.3.2   Click [Create] and create a table named BADGER_TBL.
...
-- 1.4.4   Drop your warehouse, and then recreate your database (BADGER_DB)
--         using SQL:
...
--         set, select the training_role and BADGER_wh in the context section.
