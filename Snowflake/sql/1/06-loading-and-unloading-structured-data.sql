...
-- 6.3.1   Empty the REGION Table in the PUBLIC schema of BADGER_DB:
...
-- 6.4.4   Your file should have been saved to the location you selected.
--         Examine the file using the text editor of your choice. The file
--         should have a header row and five rows of data.

-- 6.4.5   Now let’s create a CSV file format using the user interface. In the
...
--         BADGER_WH and click Next.

-- 6.4.11  You should see an option to load file from your computer. Click the
...
-- 6.4.17  You should have five rows in the REGION table now.
