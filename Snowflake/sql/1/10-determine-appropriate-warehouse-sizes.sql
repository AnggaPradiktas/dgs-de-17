...
ALTER SESSION SET QUERY_TAG = 'BADGER_WH_Sizing';
...
ALTER WAREHOUSE BADGER_WH SUSPEND;
ALTER WAREHOUSE BADGER_WH SET WAREHOUSE_SIZE = XLarge;
ALTER WAREHOUSE BADGER_WH RESUME;
...
WHERE  query_tag = 'BADGER_WH_Sizing' 
