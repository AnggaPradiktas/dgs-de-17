...
-- 3.4.4   Replace the * with an M followed by a .:
...
-- 3.13.5  Change the X-Axis to Age.

-- 3.13.6  Select labels for both axes.

-- 3.13.7  Hover the cursor over various bars in the bar chart and observe that
--         the details for that data are shown.

-- 3.13.8  Try the follow changes to observe the results:
...
-- 3.17.5  Select a table from the list and look at the Table Details and the
--         columns.
